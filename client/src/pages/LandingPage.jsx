...
const LandingPage = () => {
  ...
  const steps = [
    { icon: "📝", step: "01", title: "Register", desc: "Create your free account with your name, email, and grade." },
    { icon: "⚙️", step: "02", title: "Configure", desc: "Choose your subject, difficulty, time limit, and language." },
    { icon: "🎯", step: "03", title: "Play", desc: "Answer 8 questions at your own pace -- go back, edit, and review." },
    { icon: "📊", step: "04", title: "Analyse", desc: "See your score, stars, and performance breakdown instantly." },
    { icon: "🏆", step: "05", title: "Compete", desc: "Climb the leaderboard and track your improvement over time." },
  ];

  const features = [
    { icon: "🌐", title: "Trilingual Support", desc: "Questions available in English, Sinhala & Tamil so every student can learn in their comfort language." },
    { icon: "⭐", title: "Star-Based Rewards", desc: "Earn stars for every correct answer and build streaks to unlock higher scores." },
    { icon: "📊", title: "Smart Analytics", desc: "Visual dashboards track your score trends, topic strengths, and difficulty breakdown." },
    { icon: "🏆", title: "Live Leaderboard", desc: "Compete with fellow students in real time, filtered by subject or overall rank." },
    { icon: "⏱", title: "Flexible Timing", desc: "Choose 8-minute, 16-minute, or unlimited mode depending on your study goals." },
    { icon: "🎓", title: "Curriculum Aligned", desc: "All questions are mapped to the Sri Lanka O/L Mathematics syllabus for Grades 9-11." },
  ];
    ...
    <div className="lp-page">
      ...
      <section className="lp-section lp-features" id="features">
        <div className="lp-section-inner">
          ...
          <p className="lp-section-sub">Everything you need to go from confused to confident in O/L Maths.</p>
      ...
      <section className="lp-section lp-how" id="how">
        <div className="lp-section-inner">
          ...
          <p className="lp-section-sub">Five simple steps from sign-up to leaderboard glory.</p>
          ...
          <div className="lp-how-cards">
            <div className="lp-how-card lp-how-card--quiz">
              ...
              <div className="lp-how-card-desc">Geometry · Algebra · Numbers<br />Easy · Medium · Hard</div>
            </div>
            <div className="lp-how-card lp-how-card--play">
              <div className="lp-how-card-icon">&#9654;</div>
              <div className="lp-how-card-title">Navigate Freely</div>
              <div className="lp-how-card-desc">Go back, change answers,<br />review before submitting</div>
            </div>
            <div className="lp-how-card lp-how-card--result">
              <div className="lp-how-card-icon">📈</div>
              <div className="lp-how-card-title">See Your Progress</div>
              <div className="lp-how-card-desc">Detailed score breakdown<br />and performance trends</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="lp-section lp-faq" id="faq">
        <div className="lp-section-inner lp-faq-inner">
          <div className="lp-faq-left">
            ...
            <button className="lp-btn-primary" style={{ marginTop: "1.5rem" }} onClick={openRegister}>
              Start Learning Free
            </button>
          </div>
        ...
        <div className="lp-section-inner">
          <div className="lp-about-grid">
            <div className="lp-about-text">
              ...
              <h2 className="lp-section-title">Built for Sri Lankan Students</h2>
              <p className="lp-about-desc">
                MathsApp was created by educators who believe every student deserves
                engaging, accessible, and high-quality maths practice -- regardless of
      ...
      <section className="lp-cta">
        <div className="lp-cta-inner">
          ...
          <p className="lp-cta-sub">Join students already improving their scores with MathsApp.</p>
      ...
      <footer className="lp-footer">
        <div className="lp-footer-inner">
          ...
          <p className="lp-footer-copy">&copy; 2026 MathsApp. Built for Sri Lankan O/L students.</p>
          <div className="lp-footer-links">
            <button className="lp-footer-link" onClick={openLogin}>Sign In</button>
            <button className="lp-footer-link" onClick={openRegister}>Register</button>
          </div>
        </div>
      </footer>
